(function (global, factory) {
  ...
  function translate(el, x) {
    var y =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : x;
        ...
        value: function _checkPrize() {
          ...
          for (var i in data) {
            ...
            if (typeof d === "string") {
              ...
              data[i] = _objectSpread2(
                _objectSpread2({}, data[i]),
                {},
                {
                  text: d.text || i,
      ...
      },
      {
        ...
        value: function _drawTurntable() {
          ...
          this._svg.appendChild(
            circle(this._center[0], this._center[1], opt.radius, {
              fill: opt.color.border,
            })
          );

          this._svg.appendChild(
            circle(this._center[0], this._center[1], opt.inRadius, {
